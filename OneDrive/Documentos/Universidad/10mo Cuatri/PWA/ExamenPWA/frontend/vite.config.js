  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Bazar Online',
        short_name: 'Bazar',
        description: 'Una app de PWA para buscar en el bazar.',
        theme_color: '#ffffff',
        ...
        // ❗ CORRECCIÓN 1: Añade un array de screenshots (puede estar vacío)
        screenshots: [],

        // ❗ CORRECCIÓN 2: Todas las rutas de 'src' SIN 'public/'
        "icons": [
    {
        ...
        runtimeCaching: [
          {
            ...
            options: {
              ...
              expiration: {
                maxEntries: 100, // Aumentado por si acaso
